...
<!-- <!-         <p>Message: ${param.message}</p>
 --><!--            <p>${message}</p>
    ...
    <!--Nav Bar-->
    <nav class="navbar navbar-dark bg-dark" style="background-color: #A1CBD0;">
...
<%-- <script>
    ...
    <script type="text/javascript">
      ...
      //debugging email id
      // const CLIENT_ID='738548931441-j0ht8nskem9vaep6hnt0n7f4o67jd431.apps.googleusercontent.com';
      // const API_KEY='AIzaSyD5zwKpat0li1HB6Vndhz76-yAEyiv-LyA';
      ...
      function handleAuthClick() {
        tokenClient.callback = async (resp) => {
          if (resp.error !== undefined) {
            //console.log("handleAuthClick Error Vimal");
            throw (resp);
          }
